...
//
// #define MMC_SPI_TX_PIN  3		// GP3 spi0 TX	pin.5
// #define MMC_SPI_RX_PIN  4		// GP4 spi0 RX	pin.6
// #define MMC_SPI_SCK_PIN 2		// GP2 spi0 SCK	pin.4
// #define MMC_SPI_CSN_PIN 5		// GP5 spi0 CSn	pin.7
...
#define CS_HIGH()   { gpio_put(MMC_SPI_CSN_PIN, 1 ); /* HIGH */ }
#define	CS_LOW()    { gpio_put(MMC_SPI_CSN_PIN , 0 ); /* LOW */ }
...
static void init_spi (void)
{
    ...
    gpio_set_function( MMC_SPI_TX_PIN, GPIO_FUNC_SPI );
    gpio_set_function( MMC_SPI_RX_PIN, GPIO_FUNC_SPI );
    gpio_set_function( MMC_SPI_SCK_PIN, GPIO_FUNC_SPI );

    /* CS# */
    gpio_init( MMC_SPI_CSN_PIN );
    gpio_set_dir( MMC_SPI_CSN_PIN, GPIO_OUT);
